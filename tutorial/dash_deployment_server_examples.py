    ...
    return [
        dcc.Markdown(s('''
            ***
            ...
            ## Initializing App on Plotly Enterprise
        ...
        dcc.Markdown(s('''
            ...
            5. Now that you’ve created this app, it’s time to add some code for it to run.
...
[insert section about folder structure and file]

Below you'll find a typical dash app folder structure and a concise description of each file:
...
## Deploying App to Plotly Enterprise

[insert some info about about deployment and the options below]
...
$ pip freeze > requirements.txt
            ...
            dcc.Tab(label='Deploy Existing App', children=[
                html.Div([
                    html.P("insert push existing text"),
                ])
            ]),
        ]),
...
Redis = html.Div(children=[
    html.H1('Redis Database Examples and Reference'),
    html.Img(
        alt='Coming Soon',
...
EnvVars = html.Div(children=[
    html.H1('Enviornment Variables Examples and Reference'),
    html.Img(
        alt='Coming Soon',
        src='https://github.com/plotly/dash-docs/raw/master/images/building.png',
        style={
